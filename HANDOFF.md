...
### Phase 2: Jobdori 연동 - **완료**
| 단계 | 작업 | 설명 | 상태 |
|------|------|------|------|
| 2-1 | Neon DB 연결 | 읽기 전용 연결, 스키마 매핑 | ✅ |
| 2-2 | 동기화 엔진 | 자동/수동 동기화, 상태 반영 | ✅ |
| 2-3 | 도메인 변경 감지 | 변경 알림 + 노트 병합 워크플로우 | ⏳ (Phase 5로 이관) |
| 2-4 | Jobdori 검색 | 사이트 검색 → 수동 추가 | ✅ |
| 2-5 | Jobdori 동기화 UI 페이지 | 연결 상태, 동기화 실행, 이력 표시 | ✅ |
| 2-6 | Jobdori 사이트 조회에서 Y-EYE 추가 | 검색 결과에서 직접 사이트 등록 | ✅ |

### Phase 3: 시각화 + 타임라인 - **완료**
| 단계 | 작업 | 설명 | 상태 |
|------|------|------|------|
| 3-1 | 관계도 시각화 | SVG 기반 force-directed 네트워크 그래프 | ✅ |
| 3-2 | 타임라인 뷰 | 날짜별 그룹화, 중요도/대상/유형 필터 | ✅ |
| 3-3 | 대시보드 강화 | 빠른 탐색 카드 추가, 전체 보기 링크 | ✅ |
